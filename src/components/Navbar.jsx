            ...
            <Flex className='items-center bg-[#F5F7F9]'>
                ...
                <div className="w-full  py-2 lg:w-1/2">
                    <div className="relative ">
                        <input onChange={handleSearch} type="search" placeholder='search.....' className='w-full py-4 px-2' />
                        ...
                        {searchFilter.map((item)=>(
                            <div className="">
                                ...
                                <div className="h-[50px] w-[50px] bg-[#D8D8D8] relative">
                                            ...
                                            <div className="flex items-center z-50"><p className='pl-[20px] pr-[20px] text-dm font-bold'>{item.title} <br />
                                                ${item.price}</p>
                                                <RxCross2 />
                                            </div>
                                    ...
                                    <div className="flex items-center z-50"><p className='pl-[20px] pr-[20px] text-dm font-bold'> <h3>{item.title}</h3> <br />
                                        ${item.price}</p>
                                        <RxCross2 />
                                    </div> */}

                                </div>
                                <div className="py-5 bg-[#fff]"><p className='text-dm text-dm text-[#767676]'>subtotal:<span className='font-bold pl-5'>$....</span> </p></div>
                ...
                <div className="w-full  py-2 lg:w-1/4 flex lg:justify-end gap-x-5 relative">
                    ...
                    {cartacc && <div className=" border border-[#B885FD] w-[200px] absolute top-[50px] right-0 z-50">
                     ...
                     hover:text-white hover:pl-6 duration-500'><Link to="/accounts">My Account</Link></li>
                            <li className=' text-center text-[#262626] py-3 pl-3
                     hover:text-black hover:pl-6 duration-500'><Link to="/login">Login</Link></li>
                        </ul>
                    </div>
                    }
                                ...
                                {data.map((item) => (
                                    <div className="">
                                        ...
                                        <div className="flex gap-x-1 py-2 px-2 bg-[#fff] ">
                                            <div className="z-50"><button className='h-[40px] w-[100px] text-dm border border-[#994AFF] hover:bg-black hover:text-white duration-500 '><Link to="/cart">View Cart</Link></button></div>
                                            <div className="z-50"> <button className='h-[40px] w-[100px] text-dm border border-[#994AFF] hover:bg-black hover:text-white duration-500 '><Link to="/checkout">Checkout</Link></button></div>
